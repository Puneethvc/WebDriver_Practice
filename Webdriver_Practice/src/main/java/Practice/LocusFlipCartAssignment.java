    ...
    public static void main(String[] args) {
       ...
       WebDriverManager.chromedriver().setup();
        ...
        try {
	        ...
	        searchBar.submit();
	     // Test Case 3: Verify that the search results page is displayed after searching for 'shoes'
...
//	        } catch (Exception e) {
//	            System.err.println("Search results page is not displayed: " + e.getMessage());
//	        }
        /*
